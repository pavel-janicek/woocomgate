...
if (!class_exists('Clvr_Woo_Comgate')){
    ...
    class Clvr_Woo_Comgate extends WC_Payment_Gateway{
        ...
        public function getClient(){
            ...
            $isProd = ($this->test_mode=='no');
            $this->client = $this->comgate_client = new AgmoPaymentsSimpleProtocol($this->PAYMENTS_URL,$this->merchantId,$isProd,$edd_options['prod_password']);
        }
